...
type ServerEngine interface {
	...
	// Must be called AFTER tracing middleware to ensure trace_id is available.
	SetupLoggingMiddleware(config *configuration.MiddlewareConfig, log *logger.Logger)
	...
	RegisterStaticFiles(config *configuration.StaticFileConfig)
}
