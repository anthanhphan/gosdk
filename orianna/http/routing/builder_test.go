...
func TestRouteBuilder_POST(t *testing.T) {
	...
	route := builder.Build()
	if route.Methods[0] != core.POST {
		t.Errorf("POST() = %v, want POST", route.Methods[0])
	}
}
...
func TestRouteBuilder_PUT(t *testing.T) {
	...
	route := builder.Build()
	if route.Methods[0] != core.PUT {
		t.Errorf("PUT() = %v, want PUT", route.Methods[0])
	}
}
...
func TestRouteBuilder_PATCH(t *testing.T) {
	...
	route := builder.Build()
	if route.Methods[0] != core.PATCH {
		t.Errorf("PATCH() = %v, want PATCH", route.Methods[0])
	}
}
...
func TestRouteBuilder_DELETE(t *testing.T) {
	...
	route := builder.Build()
	if route.Methods[0] != core.DELETE {
		t.Errorf("DELETE() = %v, want DELETE", route.Methods[0])
	}
}
...
func TestRouteBuilder_FluentAPI(t *testing.T) {
	...
	if route.Methods[0] != core.POST {
		t.Errorf("Method = %v, want POST", route.Methods[0])
	}
...
func TestGroupRouteBuilder_POST(t *testing.T) {
	...
	if group.Routes[0].Methods[0] != core.POST {
		t.Errorf("Route method = %v, want POST", group.Routes[0].Methods[0])
	}
}
...
func TestGroupRouteBuilder_PUT(t *testing.T) {
	...
	if group.Routes[0].Methods[0] != core.PUT {
		t.Errorf("Route method = %v, want PUT", group.Routes[0].Methods[0])
	}
}
...
func TestGroupRouteBuilder_PATCH(t *testing.T) {
	...
	if group.Routes[0].Methods[0] != core.PATCH {
		t.Errorf("Route method = %v, want PATCH", group.Routes[0].Methods[0])
	}
}
...
func TestGroupRouteBuilder_DELETE(t *testing.T) {
	...
	if group.Routes[0].Methods[0] != core.DELETE {
		t.Errorf("Route method = %v, want DELETE", group.Routes[0].Methods[0])
	}
}
...
func TestGroupRouteBuilder_HEAD(t *testing.T) {
	...
	if group.Routes[0].Methods[0] != core.HEAD {
		t.Errorf("Route method = %v, want HEAD", group.Routes[0].Methods[0])
	}
}
...
func TestGroupRouteBuilder_OPTIONS(t *testing.T) {
	...
	if group.Routes[0].Methods[0] != core.OPTIONS {
		t.Errorf("Route method = %v, want OPTIONS", group.Routes[0].Methods[0])
	}
}
