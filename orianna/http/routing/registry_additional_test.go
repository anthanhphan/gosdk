...
func TestRegisterRoutes_Multiple(t *testing.T) {
	...
	routes := []Route{
		{Path: "/a", Methods: []core.Method{core.GET}, Handler: func(_ core.Context) error { return nil }},
		{Path: "/b", Methods: []core.Method{core.POST}, Handler: func(_ core.Context) error { return nil }},
	}
...
func TestRegisterRoutes_FailsOnInvalid(t *testing.T) {
	...
	routes := []Route{
		{Path: "/valid", Methods: []core.Method{core.GET}, Handler: func(_ core.Context) error { return nil }},
		{Path: "/invalid", Methods: []core.Method{core.GET}, Handler: nil}, // nil handler
	}
	...
	// Atomic: no routes should be registered when any route fails validation
	if len(rr.GetRoutes()) != 0 {
		t.Errorf("Expected 0 routes (atomic all-or-nothing), got %d", len(rr.GetRoutes()))
	}
}
...
func TestApplyGroupProtection_ProtectedGroup(t *testing.T) {
	...
	group := RouteGroup{
		...
		IsProtected: true,
		Routes: []Route{
			{Path: "/users", Methods: []core.Method{core.GET}, Handler: func(_ core.Context) error { return nil }},
			{Path: "/items", Methods: []core.Method{core.GET}, Handler: func(_ core.Context) error { return nil }},
		},
	}
		...
		Groups: []RouteGroup{
			{
				Prefix: "/admin",
				Routes: []Route{
					{Path: "/dashboard", Methods: []core.Method{core.GET}, Handler: func(_ core.Context) error { return nil }},
				},
			},
		},
	}
...
func (c *simpleContext) SetContext(_ context.Context)       {}
...
func (c *simpleContext) HeadersParser(any) error            { return nil }
...
func (c *simpleContext) SendStream(io.Reader, ...int) error { return nil }
func (c *simpleContext) SendFile(string) error              { return nil }
