...
func TestDuplicateRoute_SameMethodAndPath(t *testing.T) {
	...
	route := Route{Path: "/users", Methods: []core.Method{core.GET}, Handler: dummyHandler}
...
func TestDuplicateRoute_DifferentMethodsSamePath(t *testing.T) {
	...
	get := Route{Path: "/users", Methods: []core.Method{core.GET}, Handler: dummyHandler}
	post := Route{Path: "/users", Methods: []core.Method{core.POST}, Handler: dummyHandler}
...
func TestDuplicateRoute_DifferentPathsSameMethod(t *testing.T) {
	...
	r1 := Route{Path: "/users", Methods: []core.Method{core.GET}, Handler: dummyHandler}
	r2 := Route{Path: "/items", Methods: []core.Method{core.GET}, Handler: dummyHandler}
...
func TestDuplicateRoute_MultiMethods(t *testing.T) {
	...
	r2 := Route{Path: "/users", Methods: []core.Method{core.GET}, Handler: dummyHandler}
...
func TestDuplicateRoute_RegisterRoutes_BatchDuplicate(t *testing.T) {
	...
	routes := []Route{
		{Path: "/a", Methods: []core.Method{core.GET}, Handler: dummyHandler},
		{Path: "/b", Methods: []core.Method{core.POST}, Handler: dummyHandler},
		{Path: "/a", Methods: []core.Method{core.GET}, Handler: dummyHandler}, // duplicate
	}
...
func TestDuplicateRoute_GroupDuplicate(t *testing.T) {
	...
	group := RouteGroup{
		Prefix: "/api",
		Routes: []Route{
			{Path: "/users", Methods: []core.Method{core.GET}, Handler: dummyHandler},
			{Path: "/users", Methods: []core.Method{core.GET}, Handler: dummyHandler}, // duplicate within group
		},
	}
...
func TestDuplicateRoute_GroupAndTopLevel(t *testing.T) {
	...
	route := Route{Path: "/api/users", Methods: []core.Method{core.GET}, Handler: dummyHandler}
	if err := rr.RegisterRoute(route); err != nil {
		t.Fatalf("RegisterRoute() error = %v", err)
	}
		...
		Groups: []RouteGroup{
			{
				Prefix: "/v2",
				Routes: []Route{
					{Path: "/users", Methods: []core.Method{core.GET}, Handler: dummyHandler}, // /api/v2/users - no conflict
				},
			},
		},
	}
