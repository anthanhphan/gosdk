...
func TestCSRFConfigStructure(t *testing.T) {
	...
	if csrfConfig.CookieSecure == nil || !*csrfConfig.CookieSecure {
	...
	if csrfConfig.CookieHTTPOnly == nil || !*csrfConfig.CookieHTTPOnly {
...
// boolPtr is a helper to create *bool pointers for config fields.
